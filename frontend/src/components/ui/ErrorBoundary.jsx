      ...
      return (
        <div className="flex items-center justify-center min-h-[400px] p-6">
          <div className="text-center max-w-md">
            {createElement(AlertTriangle, { className: 'w-12 h-12 text-red-400 mx-auto mb-4' })}
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              >
                {createElement(RefreshCw, { className: 'w-4 h-4 inline mr-1' })} Try Again
              </button>
              <button
                onClick={this.handleGoHome}
                className="px-4 py-2 bg-dark-700 hover:bg-dark-600 text-dark-200 rounded-lg text-sm font-medium transition-colors"
              >
                {createElement(Home, { className: 'w-4 h-4 inline mr-1' })} Go Home
              </button>
            </div>
